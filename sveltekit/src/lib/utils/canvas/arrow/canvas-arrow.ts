import {canvasControllerCreateArrow, type CanvasArrowDto, type CreateCanvasArrowDto } from "$lib/client";
...
function dragArrow(startNodeId: string, layer: Konva.Layer, stage:Konva.Stage){
    ...
    const anchorAbsolutePositionArray: Konva.Vector2d[] = anchorNodes.map(node => {
